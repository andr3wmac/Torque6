...
// TorqueScript
#define mySTC_TYPE_LOCALVAR 30 
#define mySTC_TYPE_GLOBALVAR 31
#define wxSTC_LEX_TORQUESCRIPT 108
#define SCLEX_VISUALPROLOG 107
#define SCLEX_TORQUESCRIPT 108
#define SCLEX_AUTOMATIC 1000
#define SCE_TORQUESCRIPT_DEFAULT 0
#define SCE_TORQUESCRIPT_COMMENT 1
#define SCE_TORQUESCRIPT_BLOCKCOMMENT 2
#define SCE_TORQUESCRIPT_LOCALVAR 3
#define SCE_TORQUESCRIPT_GLOBALVAR 4
#define SCE_TORQUESCRIPT_IDENTIFIER 5
#define SCE_TORQUESCRIPT_STRING 6
#define SCE_TORQUESCRIPT_TAG 7
#define SCE_TORQUESCRIPT_NUMBER 8
#define SCE_TORQUESCRIPT_KEYWORD 9
#define SCE_TORQUESCRIPT_DECLARATIONKEYWORD 10
#define SCE_TORQUESCRIPT_STRINGCAT 11
#define SCE_TORQUESCRIPT_BINOP 12
#define SCE_TORQUESCRIPT_DELIMITER 13
#define SCE_TORQUESCRIPT_ERROR 14
